...
const WHY: Record<string, string> = {
  ...
  just_make_logo:
    '로고가 급할 때 디자인 도구를 켜는 대신 쓰려고 만들었습니다.',
  just_color_picker:
    '색 고르는 위젯 하나 때문에 의존성이 세 개 늘어나는 게 이상했습니다.',
};
  ...
  return (
    <li className="border-rule flex flex-col gap-2 border-b pb-7 last:border-b-0">
      <div className="flex items-baseline gap-2.5">
        <a href="#" className="text-heading font-mono font-semibold underline-offset-4 hover:underline">
          {pkg.slug}
        </a>
    ...
    <>
      ...
      <main className="mx-auto flex w-full max-w-3xl flex-col gap-10 px-6 py-16">
        <div className="rounded-panel border-rule text-small text-muted border border-dashed p-4">
          <strong className="text-ink font-semibold">주의 — 아래 굵은 문장들은 자리끼움입니다.</strong>{' '}
        ...
        <header className="flex flex-col gap-4">
          ...
          <p className="text-body max-w-(--container-measure) text-pretty">
            Flutter 로 데스크톱 앱을 만들다 보면 같은 위젯을 자꾸 다시 짜게 됩니다. 세 번째로
            같은 걸 짜고 있으면 패키지로 뗐습니다. 아래가 그렇게 나온 것들이고, 대부분은 제가
            지금도 쓰고 있습니다.
          </p>
